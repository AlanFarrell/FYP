...
def compute_coverage_grid(lats, lons, propagated_data, simulation_duration):
    grid = np.zeros((len(lats), len(lons)))

    print(f"Computing coverage for {len(lats)} x {len(lons)} points...")
